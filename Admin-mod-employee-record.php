                                ...
                                <div class="card-box" >
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            $sql = 'INSERT INTO `ad_employee_record`(`employee_record_id`, `user_id`, `user_date`, `name`, `cnic`, `position`, `assigned_section`, `age`, `start`, `salary`, `phone_number`, `address`, `comment`) VALUES (NULL,\'';
                                            $sql .= get_curr_user();
                                            $sql .= '\', CURRENT_TIMESTAMP, \''.$_REQUEST['name'].'\', \''.$_REQUEST['cnic'].'\', \''.$_REQUEST['position'].'\', \''.$_REQUEST['assigned_section'].'\', \''.$_REQUEST['age'].'\', \''.$_REQUEST['start'].'\', \''.$_REQUEST['salary'].'\', \''.$_REQUEST['phone_number'].'\', \''.$_REQUEST['address'].'\', \''.$_REQUEST['comment'].'\')';
                                                // echo $sql;
                                            insert_query($sql);
                                                }
                                            // }else{
                                            ...
                                            $sql = 'SELECT  `employee_record_id` "ID",`name`"Name", `cnic` "CNIC", `position`"Position",`assigned_section`"Assigned Section", `age`"Age", `start`, `salary`"Salary", `phone_number`"Phone", `address` "Address", `comment` "Comment" FROM `ad_employee_record`';
                                            display_query($sql);
