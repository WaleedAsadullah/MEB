                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            $sql = 'INSERT INTO `ac_fee_calculated`(`fee_calculated_id`, `user_id`, `user_date`, `annual_fee`, `amount`, `zakat_adjustment`, `from_account`) VALUES  (NULL,\'';
                                            $sql .= get_curr_user();
                                            $sql .= '\', CURRENT_TIMESTAMP, \''.$_REQUEST['annual_fee'].'\', \''.$_REQUEST['amount'].'\', \''.$_REQUEST['zakat_adjustment'].'\', \''.$_REQUEST['from_account'].'\')';
                                            insert_query($sql);
                                                }
                                            // -------------------
                                            ...
                                            $sql = 'SELECT `fee_calculated_id` "ID",  `annual_fee` "Annual Fee", `amount` "Amount", `zakat_adjustment` "Zakat Adjustment", `from_account` "From Account" FROM `ac_fee_calculated` ';
                                            display_query($sql);
