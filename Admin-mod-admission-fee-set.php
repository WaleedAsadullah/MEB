                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            $sql = 'SELECT `student_fee_id`, `user_id`, `user_date`,`gr_no`, `admitted_class`, `admission_fee`, `activities_fee`, `tution_fee`, `total` FROM `ad_student_fee`';
                                            display_query($sql);
                                    ...
                                    <form action="#" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="admitted_class" required
                                                   placeholder="Enter admitted class" class="form-control" id="adAdmittedClass"  value="<?php if(isset($_REQUEST['admitted_class'])) echo $_REQUEST['admitted_class']?>">
                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="adRNo" name="gr_no" type="text" placeholder="Enter r no." required
                                                           class="form-control"  value="<?php if(isset($_REQUEST['gr_no'])) echo $_REQUEST['gr_no']?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
