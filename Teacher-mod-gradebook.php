                                ...
                                <div class="card-box">
                                    ...
                                    <form action="Teacher-mod-gradebook.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="student_id" required="" placeholder="Enter student id" class="form-control" id="hbName" value="<?php if(isset($_REQUEST['student_id'])) echo $_REQUEST['student_id']?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="student_subject_name"  placeholder="Enter subject name" class="form-control" value="<?php if(isset($_REQUEST['student_subject_name'])) echo $_REQUEST['student_subject_name']?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="hbDateOfBooking">Student Grade</label>
                                            <input type="text" name="student_grade"  placeholder="Enter student grade" class="form-control" value="<?php if(isset($_REQUEST['student_grade'])) echo $_REQUEST['student_grade']?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="hbDateOfBooking">Student Letter Grade</label>
                                            <input type="text" name="student_letter_grade"  placeholder="Enter letter grade" class="form-control" value="<?php if(isset($_REQUEST['student_letter_grade'])) echo $_REQUEST['student_letter_grade']?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="semester"  placeholder="Enter semester" class="form-control" value="<?php if(isset($_REQUEST['semester'])) echo $_REQUEST['semester']?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="hbDateOfBooking">Year</label>
                                            <input type="text" name="year"  placeholder="Enter year" class="form-control" value="<?php if(isset($_REQUEST['year'])) echo $_REQUEST['year']?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="hbDateOfBooking">Current Class</label>
                                            <input type="text" name="current_class"  placeholder="Enter current class" class="form-control" value="<?php if(isset($_REQUEST['current_class'])) echo $_REQUEST['current_class']?>">
                                        </div>
                                        <div class="form-group">
