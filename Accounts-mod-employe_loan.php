                                ...
                                <div class="card-box">
                                    ...
                                    <form action="Accounts-mod-employe_loan.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="employee_id" required="" placeholder="Enter employee id" class="form-control" id="hbemployee_id" value="<?php if(isset($_REQUEST['employee_id'])) echo $_REQUEST['employee_id']?>">
                                        </div>
